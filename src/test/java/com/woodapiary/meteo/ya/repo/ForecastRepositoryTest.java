...
public class ForecastRepositoryTest {
    ...
    static Logger log = LoggerFactory.getLogger(ForecastRepositoryTest.class);
    ...
    @Test
    public void test01() {
        final Forecast ent = repo.save(createEntity());
    ...
    @Test
    public void test02() {
        final Forecast ent1 = repo.save(createEntity());
        final Forecast ent2 = repo.findById(ent1.getForecastId()).orElseThrow();
